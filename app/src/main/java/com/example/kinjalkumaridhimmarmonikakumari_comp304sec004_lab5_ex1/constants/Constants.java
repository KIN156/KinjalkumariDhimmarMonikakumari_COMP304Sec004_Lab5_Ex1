...
public class Constants {
   ...
   public static String MAPS_API_KEY= "AIzaSyCVET9dJjaFjnks1naY_4Ipdv0-0QqEDic";
    ...
    public static  String BASE_URl = "https://maps.googleapis.com/maps/api/place/nearbysearch/json?";
}
